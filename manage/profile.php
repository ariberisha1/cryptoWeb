...
$info = $profile->userModel->fetchuserinfo();
$profile->procesiprofilit();
?>

<div class="page-head">
    <table align="center" width="73%">
        <td>
            <font class="title-head">Profili
        </td>
    </table>
</div>
<br>
                        ...
                        <table cellspacing="2" cellpadding="6" width="50%">
                            <tr>
                                <td>
                                    ...
                                    <input type="text" class="text_profile" name="name" value="<?php echo $info['name'] ?>" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <span class="text-label"><i>Mbiemri*</i></span><br>
                                    <input type="text" class="text_profile" name="surname" value="<?php echo $info['surname'] ?>" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <span class="text-label"><i>Emaili*</i></span><br>
                                    <input type="text" class="text_profile" name="email" value="<?php echo $info['email'] ?>" />
                                </td>
                            </tr>
                            <tr><br>
                            ...
                            <td align="center">
                                <form method="POST">
                                    <table cellspacing="0" cellpadding="2" width="50%">
                                        <tr>
                                            <td><br>
                                                <span class="text-label"><i>Fjal&euml;kalimi i ri</i></span><br>
